...
Firmware_UpdateMetadataRequestGet = (0x7a, 0x03)
Firmware_UpdateMetadataRequestReport = (0x7a, 0x04)
Firmware_UpdateMetadataGet = (0x7a, 0x05)
Firmware_UpdateMetadataReport = (0x7a, 0x06)
Firmware_UpdateMetadataStatusReport = (0x7a, 0x07)
Firmware_UpdateMetadataPrepareGet = (0x7a, 0x0a)
Firmware_UpdateMetadataPrepareReport = (0x7a, 0x0b)
...
SUBCMD_TO_STRING = {
    ...
    0x7a03: 'Firmware_UpdateMetadataRequestGet',
    0x7a04: 'Firmware_UpdateMetadataRequestReport',
    0x7a05: 'Firmware_UpdateMetadataGet',
    0x7a06: 'Firmware_UpdateMetadataReport',
    0x7a07: 'Firmware_UpdateMetadataStatusReport',
    0x7a0a: 'Firmware_UpdateMetadataPrepareGet',
    0x7a0b: 'Firmware_UpdateMetadataPrepareReport',
    0x8002: 'Battery_Get',
...
STRING_TO_SUBCMD = {
    ...
    'Firmware_UpdateMetadataRequestGet': 0x7a03,
    'Firmware_UpdateMetadataRequestReport': 0x7a04,
    'Firmware_UpdateMetadataGet': 0x7a05,
    'Firmware_UpdateMetadataReport': 0x7a06,
    'Firmware_UpdateMetadataStatusReport': 0x7a07,
    'Firmware_UpdateMetadataPrepareGet': 0x7a0a,
    'Firmware_UpdateMetadataPrepareReport': 0x7a0b,
    'Battery_Get': 0x8002,
...
SUBCMD_TO_PARSE_TABLE = {
    ...
    0x3304: ['B{group}', 'B{level}', 'B{target}', 'B{duration}'],  # Report (4)
    0x3305: ['c{colors}'],  # Set (5)
    ...
    0x4c04: ['B{count}', 'D{date}', 'B{type}', 'B{user}', 'A{code}'],  # Report (4)
    ...
    0x7a02: ['W{manufacturer}', 'W{id}', 'W{checksum}', 'B{upgradable}', 'B{n_targets}', 'W{max_fragment_size}', 'L{data}'],  # MetadataReport (2)
    0x7a03: ['W{manufacturer}', 'W{id}', 'W{checksum}', 'B{target}', 'W{fragment_size}', 'B{activation}', 'B{hardware_version}'],  # UpdateMetadataRequestGet (3)
    0x7a04: ['B{status}'],  # UpdateMetadataRequestReport (4)
    0x7a05: ['B{n_reports}', 'W{report_number}'],  # UpdateMetadataGet (5)
    0x7a06: ['W{report_number}', 'L{data}'],  # UpdateMetadataReport (6)
    0x7a07: ['B{status}'],  # UpdateMetadataStatusReport (7)
    0x7a0a: ['W{manufacturer}', 'W{id}', 'W{checksum}', 'B{target}', 'W{fragment_size}', 'B{hardware_version}'],  # UpdateMetadataPrepareGet (10)
    0x7a0b: ['B{status}', 'W{checksum}'],  # UpdateMetadataPrepareReport (11)
